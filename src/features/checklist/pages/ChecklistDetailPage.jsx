...
const CHECKLIST_DATA = {
  ...
  water: {
    ...
    warningText: "물이 너무 약하거나, 동시에 틀었을 때 수압이 약해지는 경우",
  ...
  light: {
    ...
    whyText: "채광은 집안의 밝기와 곰팡이 예방에 큰 영향을 줍니다.",
    ...
    warningText: "창문 앞에 건물이 가로막혀 햇빛이 전혀 안 드는 경우",
  ...
  drain: {
    ...
    whyText: "배수가 잘되지 않으면 물이 고이거나 악취가 발생할 수 있습니다.",
    ...
    warningText: "물이 천천히 빠지거나 역류하는 경우",
  ...
  mold: {
    ...
    whyText: "곰팡이는 습기와 결로 문제의 신호일 수 있습니다.",
    ...
    warningText: "검은색이나 초록색 곰팡이 흔적이 보이는 경우",
  ...
  bugs: {
    ...
    warningText: "벌레 사체나 배설물, 알 등의 흔적이 보이는 경우",
...
export default function ChecklistDetailPage() {
  ...
  const [memo, setMemo] = useState("샤워기는 괜찮은데 싱크대가 좀 약함");
    ...
    <div className="p-4 space-y-6 pb-24">
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
        <div className="flex justify-between items-center mb-2">
          <span className="font-bold text-gray-950 text-[16px]">메모</span>
      ...
      <div className="space-y-3">
        ...
        <div className="bg-[#FFF5F5] border border-[#FFE3E3] rounded-xl p-4 text-red-600 relative">
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="font-bold text-[14px]">이런 경우 주의하세요!</p>

              <p className="text-[13px] mt-0.5">{data.warningText}</p>
            </div>
          </div>
